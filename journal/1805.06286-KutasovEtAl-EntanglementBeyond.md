...
This $p = p_\varphi$ is the conserved momentum, not to be confused with the parameter $p = 1$.
...
$$
  p = \frac{\sqrt{\rho_0^2 + 2\lambda}}{\rho_0^2}
$$

$$
  L
  = \int\dd{\varphi}\,
      \frac{\sqrt{\rho^2 + 2\lambda}}{\rho^2}
  = 2\int_0^{\rho_0}
      \frac{\sqrt{\rho^2 + 2\lambda}}{\rho^2}
      \abs{\dv{\varphi}{\rho}}
      \dd{\rho}
  = 2\int_0^1
      \frac{\dd{y}}{\sqrt{
        \frac{1}{y^2 (\rho_0^2 + 2\lambda)}
        - \frac{y^2}{\rho_0^2 y^2 + 2\lambda}
      }}
$$
